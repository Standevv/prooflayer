...
export default async function AssetMonitoringPage({ params }: { params: Promise<{ asset: string }> }) {
  ...
  return <div className="min-h-screen bg-[#0b0c10]"><Sidebar /><main className="lg:ml-[240px]"><div className="mx-auto max-w-[1240px] px-4 py-4 sm:px-6 lg:px-8 lg:py-6"><AssetMonitor asset={normalized} /><footer className="mt-5 flex flex-col gap-1 border-t border-white/[0.08] py-4 text-[10px] leading-4 text-[#747987] sm:flex-row sm:justify-between"><p>Deterministic snapshots · Factual transitions · Local JSONL history</p><p>No blockchain writes · No OpenAI calls</p></footer></div></main></div>;
}
