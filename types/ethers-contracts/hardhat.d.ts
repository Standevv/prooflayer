...
getContractFactory(name: 'ProofLayerMarketAdapter', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.ProofLayerMarketAdapter__factory>
...
getContractAt(name: 'ProofLayerMarketAdapter', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.ProofLayerMarketAdapter>
...
deployContract(name: 'ProofLayerMarketAdapter', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.ProofLayerMarketAdapter>
...
deployContract(name: 'ProofLayerMarketAdapter', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.ProofLayerMarketAdapter>
